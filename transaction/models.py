...
class Transaction(BaseModelMixin):
    ...
    result = models.CharField(
        ...
        default=ResultChoices.FAILED,
        max_length=7,
        help_text=_("트랜잭션 결과값"),
    )
    status = models.CharField(
        _("상태"),
        choices=ConfirmedChoices.choices,
        default=ConfirmedChoices.UNCONFIRMED,
        max_length=11,
        help_text=_("컨펌상태에 의한 결과값 ( > 20 일 경우 True"),
    )
    ...
    tx_type = models.CharField(
        _("거래구분"),
        choices=TxTypeChoices.choices,
        default=TxTypeChoices.CREATE_CONTRACT,
        max_length=21,
    )
