...
class Contract(BaseModelMixin):
    ...
    wallet = models.ForeignKey(
        Wallet, on_delete=models.SET_NULL, null=True, blank=True, verbose_name=_("지갑")
    )

    contract_address = models.CharField(
        _("컨트랙트 주소"), max_length=34, null=True, blank=True
    )
    trc_type = models.CharField(
        _("TRC 타입"),
        choices=TrcTypeChoices.choices,
        default=TrcTypeChoices.TRC721,
        max_length=6,
    )
